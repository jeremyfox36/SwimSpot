...
namespace SwimSpot.Api.Models
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SwimmingSpot>().HasData(new SwimmingSpot { SwimmingSpotId = 1, SwimmingSpotName = "Gladhouse Reservoir", Latitude = 55.6455217723385M, Longitude = -2.9060585301065363M });
            ...
            modelBuilder.Entity<SwimmingSpot>().HasData(new SwimmingSpot { SwimmingSpotId = 2, SwimmingSpotName = "Stantling Craigs", Latitude = 55.77398808982048M, Longitude = -3.1221541644140895M });
